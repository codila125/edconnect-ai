      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center p-4">
        <div className="text-center">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-12 max-w-md">
            ...
            <h2 className="text-xl font-light text-slate-800 mb-2">Loading Contents</h2>
            <p className="text-slate-500 text-sm">Fetching contents for class {params.classId}</p>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center p-4">
        <div className="text-center max-w-md">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-red-200/50 p-8">
            ...
            <h2 className="text-xl font-semibold text-red-800 mb-3">Error Loading Contents</h2>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="text-center mb-10">
          <h1 className="text-4xl font-light text-slate-800 mb-3">Class Contents</h1>
        </div>
          ...
          {contents.length > 0 ? (
            <div className="space-y-8">
              {contents.map((content) => (
                <div key={content.id} className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 overflow-hidden">
                  {/* Content Header */}
                  <div className="bg-gradient-to-r from-blue-50 to-emerald-50 p-6 border-b border-white/20">
                    <h3 className="text-2xl font-semibold text-slate-800 mb-2">{content.title}</h3>
                  </div>
                      ...
                      <div className="border-t border-slate-200 pt-6">
                        ...
                        <div className="space-y-3 mb-6">
                          {urls.map((material, index) => (
                            <div key={material.id || index} className="bg-slate-50 rounded-xl p-4 border border-slate-200">
                              <p className="font-medium text-slate-800 mb-2">{material.name}</p>
                              <a 
                                href={material.url} 
                                target="_blank" 
                        ...
                        <div className="bg-gradient-to-r from-emerald-50 to-blue-50 rounded-xl p-6">
                          <h4 className="text-lg font-semibold text-slate-800 mb-3 flex items-center">
                            <svg className="w-5 h-5 mr-2 text-emerald-600" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="text-center py-16">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-12 max-w-md mx-auto">
                ...
                <h3 className="text-xl font-light text-slate-800 mb-2">No Contents Available</h3>
                <p className="text-slate-500">No contents found for this class yet.</p>
              </div>
            </div>
          )}
        </div>
          ...
          <div className="mb-12">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-8">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-slate-800">Add New Content</h2>
                  <p className="text-slate-500 text-sm">Create new content for your students</p>
                </div>
              </div>
