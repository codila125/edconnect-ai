            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center p-4">
                <div className="text-center">
                    <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-12 max-w-md">
                        ...
                        <h2 className="text-xl font-light text-slate-800 mb-2">Loading</h2>
                            ...
                            {role === "teacher" && (
                                <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-8">
                                    <div className="flex items-center mb-6">
                                        ...
                                        <div>
                                            <h2 className="text-xl font-semibold text-slate-800">Teacher Tools</h2>
                                            <p className="text-slate-500 text-sm">Create and manage your classes</p>
                                        </div>
                                    </div>
                                    <AddClass />
                                </div>
                            ...
                            {role === "student" && (
                                <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-8">
                                    <div className="flex items-center mb-6">
                                        ...
                                        <div>
                                            <h2 className="text-xl font-semibold text-slate-800">Student Hub</h2>
                                            <p className="text-slate-500 text-sm">Join new classes and access your courses</p>
                                        </div>
                                    </div>
                                    <JoinClass />
                                </div>
